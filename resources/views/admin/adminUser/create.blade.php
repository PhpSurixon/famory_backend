@extends('layouts.admin-master', ['title' => 'Admin Create Users'])
@section('content')
                     ...
                     <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                           ...
                           <input type="email" name="email" placeholder="Enter Email..."
                              ...
                              autocomplete="email" id="basic-default-email" required/>
                           @error('email')
                           <span class="help-block invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                           ...
                           <input type="number" id="basic-default-phone" name="phone"
                              ...
                              value="{{ old('phone') }}" autocomplete="phone" placeholder="Enter Phone No..." required/>
                           @error('phone')
                           <span class="help-block invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
