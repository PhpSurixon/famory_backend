@extends('layouts.admin-master', ['title' => 'About Page'])
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                     ...
                     @if(session('error'))
                        ...
                        @endif
                    <div class="card-body">
                        <form action="{{ route('update-about',$getdata->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="editor" style="height: 400px;" class="@error('page_content') is-invalid @enderror">{!!$getdata->details!!}</div>
                                    @error('page_content')
                                        <span class="help-block invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
