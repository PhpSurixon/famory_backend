            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Create Subscription Setting</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('store-subscription-setting') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            value="{{ old('title') }}" autocomplete="title" autofocus id="basic-default-title"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control @error('plans') is-invalid @enderror"
                                            value="{{ old('plans') }}" autocomplete="plans" autofocus id="basic-default-name"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control @error('plan_id_ios') is-invalid @enderror"
                                            value="{{ old('plan_id_ios') }}" autocomplete="plan_id_ios" autofocus id="basic-default-price"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control @error('plan_id_android') is-invalid @enderror"
                                            value="{{ old('plan_id_android') }}" autocomplete="plan_id_android" autofocus id="basic-default-price"
                             ...
                             <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        ...
                                        <!--    value="{{ old('benefits') }}" autocomplete="benefits" autofocus id="basic-default-name"-->
                                        <!--    placeholder="Enter Benefits..." name="benefits" />-->
                                        <textarea data-rule-required="true" data-msg-required="Benefits is required" class="form-control" placeholder=" Enter Benefits" id="benefits" name="benefits" spellcheck="false" style="height: 60px;"></textarea>
                                        @error('benefits')
                                            <span class="help-block invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
