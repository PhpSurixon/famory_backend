 ...
 <style>
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header d-flex align-items-center justify-content-end"> <a href="{{ route('create-subscription-setting') }}"
                ...
                <div class="table-responsive text-nowrap">
                    ...
                    @endif
                    <div class="alert alert-success hidden" class="successMessage">
                        <span></span>
                    </div>
                </div>
                                            ...
                                            <div class="dropdown">
                                                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('edit-subscription-setting',$data->id) }}">
        ...
        if (id !== '') {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('destroy-subscription-setting', '') }}/" + id,
                        type: "post",
                        headers: {
