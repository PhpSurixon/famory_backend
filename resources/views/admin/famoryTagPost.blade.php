...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="main-box">
        <h5 class="card-header d-flex align-items-center justify-content-between">Tag ID:- {{$tag_id}}<a href="{{ route('famory-tags') }}" class="btn btn-primary m-b-9">Back</a></h5>
        <div class="row">
                    ...
                    <div class="card">
                        ...
                        @endphp
                            ...
                            @elseif($file && in_array($extension, $audioExtensions))
                                <div class="audio-container " style="border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;    background-size: cover;background-repeat: no-repeat;height: 220px;background-image:url('{{ asset('assets/img/audio_bg.png') }}');">
                                    <h5 style="color:#fff; margin-bottom: 20px; margin-top: 30px;">Listen to Audio:</h5>
                                    <audio class="w-100" controls autoplay muted >
                            ...
                            <div class= "video-container ">
                                <video class="card-img-top" autoplay="autoplay" autoplay muted controls >
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="card-text mb-0"><small class="text-muted"><img src="{{ url('/') }}/assets/img/comment.png" height="20px" width="20px" alt="..."> <b>: 0 </b></small></p>
                                </div>
                            <hr>
                            ...
                            <hr>
                                ...
                                <div class="schedule-container">
                                    ...
                                    <p class="card-text mb-0"><small class="text-muted">Reoccurring Type: </small><small>{{ ucfirst($post['scheduling_post']['reoccurring_type']) }}</small></p>
                                    <p class="card-text mb-0"><small class="text-muted">Reoccurring Time: </small><small>{{ $post['scheduling_post']['reoccurring_time'] ?? 'Not set' }}</small></p>
